...
public class GUIControl : MonoBehaviour
{
	...
	void OnGUI ()
	{
		...
		if (selectedBuilding != null) {
			...
			GUI.BeginGroup (new Rect (Screen.width / 5, Screen.height / 5 * 4, Screen.width / 5, Screen.height / 5));
			GUI.Box (new Rect (0, 0, Screen.width / 5, Screen.height / 5), "");
			...
			GUI.BeginGroup (new Rect (Screen.width / 5 * 2, Screen.height / 5 * 4, Screen.width / 5 * 2, Screen.height / 5));
